        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
          <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
            ...
            <View style={styles.form}>
              {[
                { label: 'Display Name', icon: 'user', value: displayName, setter: setDisplayName, placeholder: 'Your Name', autoCapitalize: 'words' },
                { label: 'Username', icon: 'at-sign', value: username, setter: setUsername, placeholder: 'username', autoCapitalize: 'none' },
              ...
              ].map(({ label, icon, value, setter, placeholder, autoCapitalize, keyboardType }) => (
                <View key={label} style={styles.field}>
                  <Text style={styles.label}>{label}</Text>
                  <View style={styles.inputWrap}>
                    <Feather name={icon} size={16} color={COLORS.textMuted} style={styles.inputIcon} />
                    <TextInput
                      style={styles.input}
